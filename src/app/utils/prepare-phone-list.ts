...
export const preparePhoneList = (originalUserPhoneList: PhoneList, isDisplayPhone: boolean, callback: (phone: { type: number, typeDescription: string, number: string; }) => void) => {
